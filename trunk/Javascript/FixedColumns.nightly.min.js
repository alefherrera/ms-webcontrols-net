...
*/
var FixedColumns;
(function(c,s){FixedColumns=function(a,d){if(!this instanceof FixedColumns)alert("FixedColumns warning: FixedColumns must be initialised with the 'new' keyword.");else{if(typeof d=="undefined")d={};this.s={dt:a.fnSettings(),iTableColumns:a.fnSettings().aoColumns.length,aiOuterWidths:[],aiInnerWidths:[],bOldIE:c.browser.msie&&(c.browser.version=="6.0"||c.browser.version=="7.0")};this.dom={scroller:null,header:null,body:null,footer:null,grid:{wrapper:null,dt:null,left:{wrapper:null,head:null,body:null,
foot:null},right:{wrapper:null,head:null,body:null,foot:null}},clone:{left:{header:null,body:null,footer:null},right:{header:null,body:null,footer:null}}};this.s.dt.oFixedColumns=this;this._fnConstruct(d)}};FixedColumns.prototype={fnUpdate:function(){this._fnDraw(true)},fnRedrawLayout:function(){this._fnGridLayout()},fnRecalculateHeight:function(a){a._DTTC_iHeight=null;a.style.height="auto"},fnSetRowHeight:function(a,d){var b=c(a).children(":first");b=b.outerHeight()-b.height();if(c.browser.mozilla||
...
else{this.s=c.extend(true,this.s,FixedColumns.defaults,a);this.dom.grid.dt=c(this.s.dt.nTable).parents("div.dataTables_scroll")[0];this.dom.scroller=c("div.dataTables_scrollBody",this.dom.grid.dt)[0];a=c(this.dom.grid.dt).width();var g=0,f=0;c("tbody>tr:eq(0)>td, tbody>tr:eq(0)>th",this.s.dt.nTable).each(function(h){b.s.aiInnerWidths.push(c(this).width());d=c(this).outerWidth();b.s.aiOuterWidths.push(d);if(h<b.s.iLeftColumns)g+=d;if(b.s.iTableColumns-b.s.iRightColumns<=h)f+=d});if(this.s.iLeftWidth===
null)this.s.iLeftWidth=this.s.sLeftWidth=="fixed"?g:g/a*100;if(this.s.iRightWidth===null)this.s.iRightWidth=this.s.sRightWidth=="fixed"?f:f/a*100;this._fnGridSetup();for(a=0;a<this.s.iLeftColumns;a++)this.s.dt.oInstance.fnSetColumnVis(a,false);for(a=this.s.iTableColumns-this.s.iRightColumns;a<this.s.iTableColumns;a++)this.s.dt.oInstance.fnSetColumnVis(a,false);c(this.dom.scroller).scroll(function(){b.dom.grid.left.body.scrollTop=b.dom.scroller.scrollTop;if(b.s.iRightColumns>0)b.dom.grid.right.body.scrollTop=
b.dom.scroller.scrollTop});c(s).resize(function(){b._fnGridLayout.call(b)});var e=true;this.s.dt.aoDrawCallback=[{fn:function(){b._fnDraw.call(b,e);b._fnGridHeight(b);e=false},sName:"FixedColumns"}].concat(this.s.dt.aoDrawCallback);this._fnGridLayout();this._fnGridHeight();this.s.dt.oInstance.fnDraw(false)}},_fnGridSetup:function(){this.dom.body=this.s.dt.nTable;this.dom.header=this.s.dt.nTHead.parentNode;this.dom.header.parentNode.parentNode.style.position="relative";var a=c('<div class="DTFC_ScrollWrapper" style="position:relative; clear:both;"><div class="DTFC_LeftWrapper" style="position:absolute; top:0; left:0;"><div class="DTFC_LeftHeadWrapper" style="position:relative; top:0; left:0; overflow:hidden;"></div><div class="DTFC_LeftBodyWrapper" style="position:relative; top:0; left:0; overflow:hidden;"></div><div class="DTFC_LeftFootWrapper" style="position:relative; top:0; left:0; overflow:hidden;"></div></div><div class="DTFC_RightWrapper" style="position:absolute; top:0; left:0;"><div class="DTFC_RightHeadWrapper" style="position:relative; top:0; left:0; overflow:hidden;"></div><div class="DTFC_RightBodyWrapper" style="position:relative; top:0; left:0; overflow:hidden;"></div><div class="DTFC_RightFootWrapper" style="position:relative; top:0; left:0; overflow:hidden;"></div></div></div>')[0];
...
k=c(this.s.dt.aoColumns[m].nTh).clone(true)[0];k.innerHTML="";oStyle=k.style;oStyle.paddingTop="0";oStyle.paddingBottom="0";oStyle.borderTopWidth="0";oStyle.borderBottomWidth="0";oStyle.height=0;oStyle.width=f.s.aiInnerWidths[m]+"px";h.appendChild(k)}c(">tbody>tr",f.dom.body).each(function(n){var r=this.cloneNode(false);n=f.s.dt.oFeatures.bServerSide===false?f.s.dt.aiDisplay[f.s.dt._iDisplayStart+n]:n;for(o=0;o<b.length;o++){m=b[o];if(typeof f.s.dt.aoData[n]._anHidden[m]!="undefined"){k=c(f.s.dt.aoData[n]._anHidden[m]).clone(true)[0];
